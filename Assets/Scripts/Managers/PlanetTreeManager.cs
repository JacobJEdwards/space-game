...
namespace Managers
{
    public class PlanetTreeManager : PlanetObjectManager<Objects.Tree>
    {
        ...
        protected override void Spawn(Objects.Tree tree)
        {
            tree.transform.localScale = Vector3.one * Random.Range(2f, 10f);
        }
    }
}