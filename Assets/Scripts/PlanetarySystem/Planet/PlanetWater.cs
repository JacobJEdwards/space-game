...
public class PlanetWater : MonoBehaviour
{
    ...
    {
        if (_waterMeshFilters == null || _waterMeshFilters.Length == 0)
        {
        ...
        for (var i = 0; i < 6; i++)
        {
            ...
            _waterFaces[i] = new WaterFace(_waterMeshFilters[i].sharedMesh, resolution, directions[i], planetShapeSettings.planetRadius * waterLevel);
        }
    }
