...
namespace Microlight.MicroBar
{
    ...
    public class MicroBar_Editor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            var editorModeProperty = serializedObject.FindProperty("editorMode");
            var animationsProperty = serializedObject.FindProperty("animations");
            var simpleBarProperty = serializedObject.FindProperty("simpleBar");
            ...
            var modeHeaderRect = new Rect(EditorGUIUtility.currentViewWidth / 2 - 200 / 2,
                2,
                modeHeaderWidth,
            ...
            float modeButtonX = 0;
            var modeButtonY = GUILayoutUtility.GetLastRect().yMax + MicroEditor_Utility.VerticalSpacing;
            ...
            if (EditorGUIUtility.currentViewWidth > MicroEditor_Utility.SingleRowThreshold)
            {
                ...
                simpleModeButtonRect = new Rect(modeButtonX, modeButtonY, modeButtonWidth,
                    MicroEditor_Utility.HeaderLineHeight);
                modeButtonX = EditorGUIUtility.currentViewWidth / 2;
                advancedModeButtonRect = new Rect(modeButtonX, modeButtonY, modeButtonWidth,
                    MicroEditor_Utility.HeaderLineHeight);
            }
            else
            {
                ...
                simpleModeButtonRect = new Rect(modeButtonX, modeButtonY, modeButtonWidth,
                    MicroEditor_Utility.HeaderLineHeight);
                advancedModeButtonRect = new Rect(modeButtonX,
                    modeButtonY + MicroEditor_Utility.HeaderLineHeight + MicroEditor_Utility.VerticalSpacing,
                    modeButtonWidth, MicroEditor_Utility.HeaderLineHeight);
            }
            ...
            if (EditorGUIUtility.currentViewWidth > MicroEditor_Utility.SingleRowThreshold)
                ...
                EditorGUILayout.Space(
                    MicroEditor_Utility.HeaderLineHeight * 2 + MicroEditor_Utility.VerticalSpacing * 2);
            ...
            if ((MicroBarEditorMode)editorModeProperty.enumValueIndex == MicroBarEditorMode.Advanced)
            {
                ...
                var arraySize = animationsProperty.arraySize;
                for (var i = 0; i < arraySize; i++)
                {
                    var elementProperty = animationsProperty.GetArrayElementAtIndex(i);
                ...
                // Add new animation
                var buttonWidth = EditorGUIUtility.currentViewWidth - 20;
                var buttonX = GUILayoutUtility.GetLastRect().x - 8;
                var buttonRect = new Rect(buttonX,
                    GUILayoutUtility.GetLastRect().yMax + MicroEditor_Utility.VerticalSpacing, buttonWidth,
                    MicroEditor_Utility.HeaderLineHeight);

                if (GUI.Button(buttonRect, "Add Animation")) AddNewItemToList(animationsProperty);
                EditorGUILayout.Space(MicroEditor_Utility.HeaderLineHeight + MicroEditor_Utility.VerticalSpacing);
            }
        ...
        private static Rect RemoveButtonRect(Rect position)
        {
            return new Rect(
        ...
        private static void AddNewItemToList(SerializedProperty animationsProperty)
        {
        ...
        private static void ChangeMode(SerializedProperty editorModeProperty, MicroBarEditorMode newEditorMode)
        {
        ...
        private static void RemoveItem(SerializedProperty animationsProperty, int index)
        {
            animationsProperty.DeleteArrayElementAtIndex(index);
            animationsProperty.serializedObject.ApplyModifiedProperties();
        }

        private static void ResetAnimationState(SerializedProperty animationProperty)
        {
            ...
            // Reset commands
            var commandsProperty = animationProperty.FindPropertyRelative("commands");
