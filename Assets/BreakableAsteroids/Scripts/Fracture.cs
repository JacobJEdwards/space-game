...
public class Fracture : MonoBehaviour
{
    ...
    public void FractureObject()
    {
        ...
        fracturedInstance.transform.localScale = transform.localScale; //Set the scale of the broken object to the scale of the original object

        foreach (var rb in fracturedInstance.GetComponentsInChildren<Rigidbody>()) //Get all the rigidbodies in the object
        {
